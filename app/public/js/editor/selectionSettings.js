...
(function () {
  ...
  var selectionSettings = function () {
    ...
    //   $(`${this.containerSelector} .toolpanel#select-panel .content`).append(`
        ...
        // </div>
    //   `);
       $(`${this.containerSelector} .toolpanel#font-panel .font-style i`).click(function () {
      ...
      $(`${this.containerSelector} .toolpanel#font-panel .family #font-family`).change(function () {
        let family = $(this).val();
        setActiveFontStyle(_self.activeSelection, 'fontFamily', family)
        _self.canvas.renderAll(), _self.canvas.trigger('object:modified');
      })

      $(`${this.containerSelector} .toolpanel#font-panel .sizes input`).change(function () {
      ...
      $(`${this.containerSelector} .toolpanel#font-panel .align #text-align`).change(function () {
        let mode = $(this).val();
        setActiveFontStyle(_self.activeSelection, 'textAlign', mode);
        _self.canvas.renderAll(), _self.canvas.trigger('object:modified');
      })

      // $(`${this.containerSelector} .toolpanel#font-panel .color #color-picker`).spectrum({
      //   type: "color",
      //   showInput: "true",
      //   allowEmpty: "false"
      // });

      // $(`${this.containerSelector} .toolpanel#font-panel .color #color-picker`).change(function () {
      //   let color = $(this).val();
